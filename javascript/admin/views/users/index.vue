        ...
        <table class="stripes large-space table-users">
          ...
          <tbody>
            <tr v-for="user in store.users">
              <td><router-link :to="{name: 'user', params: {id: user.id}}" class="link">{{ user.id }}</router-link></td>
              <td>{{ user.created_at }}</td>
              <td>{{ user.role }}</td>
              <td><router-link :to="{name: 'user', params: {id: user.id}}" class="link">{{ user.name }}</router-link></td>                
